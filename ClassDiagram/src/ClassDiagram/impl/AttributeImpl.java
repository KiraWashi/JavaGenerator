...
public class AttributeImpl extends NamedElementImpl implements Attribute {
	...
	public void setOwner(Classifier newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != ClassDiagramPackage.ATTRIBUTE__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, ClassDiagramPackage.CLASSIFIER__ATTRIBUTES, Classifier.class, msgs);
	...
	public void setMultiplicity(int newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagramPackage.ATTRIBUTE__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
	...
	public boolean attributeNotVoid(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			/**
			 *
			 * inv attributeNotVoid:
			 *   let severity : Integer[1] = constraintName.getSeverity()
			 *   in
			 *     if severity <= 0
			 *     then true
			 *     else
			 *       let result : Boolean[?] = not self.type.oclIsTypeOf(VoidType)
			 *       in
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, ClassDiagramPackage.Literals.ATTRIBUTE___ATTRIBUTE_NOT_VOID__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_ClassDiagram_c_c_VoidType = idResolver.getClass(ClassDiagramTables.CLSSid_VoidType, null);
				final /*@NonInvalid*/ Type type = this.getType();
				final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, type, TYP_ClassDiagram_c_c_VoidType).booleanValue();
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ClassDiagramPackage.ATTRIBUTE__OWNER:
				return eInternalContainer().eInverseRemove(this, ClassDiagramPackage.CLASSIFIER__ATTRIBUTES, Classifier.class, msgs);
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassDiagramPackage.ATTRIBUTE___ATTRIBUTE_NOT_VOID__DIAGNOSTICCHAIN_MAP:
				return attributeNotVoid((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
