...
public class ClassDiagramPackageImpl extends EPackageImpl implements ClassDiagramPackage {
	 ...
	 */
	@Override
	public EReference getMethod_ReturnVariable() {
	 ...
	 */
	@Override
	public EReference getOperation_LocalVariables() {
	 ...
	 */
	@Override
	public EReference getAttributeReference_Atttribute() {
	 ...
	 */
	@Override
	public EAttribute getAttributeReference__name() {
		return (EAttribute)attributeReferenceEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(operationEClass, OPERATION__LOCAL_VARIABLES);
	...
	public void initializePackageContents() {
		...
		initEReference(getAttribute_InitialValue(), this.getData(), null, "initialValue", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethod_ReturnVariable(), this.getVar(), null, "returnVariable", null, 0, 1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperation_LocalVariables(), this.getVariable(), null, "localVariables", null, 0, -1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAssignment_Variable(), this.getVar(), null, "variable", null, 1, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createCollectionAnnotations() {
		...
		addAnnotation
		  (getMethod_ParamTypes(),
		   source,
		   new String[] {
			   "nullFree", "false"
		   });
		addAnnotation
		  (getMethod_ParamNames(),
		   source,
		   new String[] {
			   "nullFree", "false"
		   });
		addAnnotation
		  (getOperation_LocalVariables(),
		   source,
		   new String[] {
			   "nullFree", "false"
		   });
