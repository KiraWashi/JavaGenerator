...
/**
 * This is the item provider adapter for a {@link ClassDiagram.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends NamedElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParamNamesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramPackage.Literals.METHOD__RETURN_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addReturnVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_returnVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_returnVariable_feature", "_UI_Method_type"),
				 ClassDiagramPackage.Literals.METHOD__RETURN_VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParamTypesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_paramTypes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_paramTypes_feature", "_UI_Method_type"),
				 ClassDiagramPackage.Literals.METHOD__PARAM_TYPES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Param Names feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParamNamesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_paramNames_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_paramNames_feature", "_UI_Method_type"),
				 ClassDiagramPackage.Literals.METHOD__PARAM_NAMES,
				 true,
				 false,
				 false,
