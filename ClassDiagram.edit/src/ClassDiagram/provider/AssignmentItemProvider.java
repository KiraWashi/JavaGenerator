...
/**
 * This is the item provider adapter for a {@link ClassDiagram.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramPackage.Literals.ASSIGNMENT__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void add_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment__name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment__name_feature", "_UI_Assignment_type"),
				 ClassDiagramPackage.Literals.ASSIGNMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassDiagramPackage.Literals.ASSIGNMENT__EXPRESSION);
		}
	...
	public String getText(Object object) {
		String label = ((Assignment)object).get_name();
