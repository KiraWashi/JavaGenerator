...
/**
 * This is the item provider adapter for a {@link ClassDiagram.ParameterReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterReferenceItemProvider extends ExpressionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramPackage.Literals.PARAMETER_REFERENCE__PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void add_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterReference__name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterReference__name_feature", "_UI_ParameterReference_type"),
				 ClassDiagramPackage.Literals.PARAMETER_REFERENCE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ParameterReference)object).get_name();
