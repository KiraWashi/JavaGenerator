...
/**
 * This is the item provider adapter for a {@link ClassDiagram.VariableReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableReferenceItemProvider extends ExpressionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassDiagramPackage.Literals.VARIABLE_REFERENCE__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void add_namePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableReference__name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableReference__name_feature", "_UI_VariableReference_type"),
				 ClassDiagramPackage.Literals.VARIABLE_REFERENCE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VariableReference)object).get_name();
